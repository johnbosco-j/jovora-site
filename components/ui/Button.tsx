...
const base =
  "group inline-flex h-11 min-w-11 items-center justify-center gap-2 rounded-full px-5 text-[15px] font-medium whitespace-nowrap transition-[background-color,border-color,color,transform,box-shadow] duration-1 ease-out active:scale-[0.98]";

const variants: Record<Variant, string> = {
  primary: "bg-orange text-black shadow-[0_0_0_0_rgb(255_106_26/0)] hover:bg-orange-hot hover:shadow-[0_8px_32px_-8px_rgb(255_106_26/0.55)] active:bg-orange-deep",
